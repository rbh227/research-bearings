# Pre-mortem: Pre image only head

<!-- SYNTHETIC FIXTURE for evals/rank-*. Not a real judgement. -->

## The idea, restated

Train the damage head on the pre-image alone and use the post-image only as a consistency signal, restated for the fixture.
