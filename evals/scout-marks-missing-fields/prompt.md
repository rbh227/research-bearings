...
> Question: building damage assessment from post-disaster satellite imagery, and the work it builds on
> Budget: 25 papers touched. Run slug: `damage-assessment-foundations`. Unanchored — there is no
...
> script's answers. Do not run any command. Write `research/landscape/damage-assessment-foundations.md`.
