...
The recall reference for the scout and landscape runs. Originally scoped to
one example question — post-disaster building damage assessment from aerial
and satellite imagery — and widened on 2026-09-14 to the wildfire field as a
whole: detection, mapping, spread, drivers, smoke, and the damage assessment
that follows a fire.
...
damage run is graded on *damage assessment*, *structure loss and the WUI*,
