# Reading: BDANet: Multiscale Convolutional Neural Network With Cross-Directional Attention for Building Damage Assessment From Satellite Images
...
- Ids: arXiv `2105.07364` · DOI `10.1109/TGRS.2021.3080580` · CorpusId
  234742348 · S2 paperId `013ec50cdd6524f78bb0f575f5b51a498c669fcb`
- Code: https://github.com/ShaneShen/BDANet-BuildingDamage-Assessment — the
  paper states the code "is available at" that URL but says nothing about
  whether it has been verified to run.
- Read: 2026-09-16 · pass full · text: fetched from
  https://arxiv.org/pdf/2105.07364
...
Full text at
`/Users/raphaelhaytene/.cache/research-bearings/fetch/arxiv-2105.07364/full.txt`,
62,539 characters, pass: full. Not read: the figures and tables were read
only as pdftotext-extracted text, not as rendered images, so any
information conveyed purely visually (e.g. the qualitative comparisons in
Figs. 5, 6, 7, 9, and the training-curve plot in Fig. 8) was not read
directly — only their captions and the surrounding prose discussion.
